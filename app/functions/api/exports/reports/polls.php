                ...
                <td style="background: <?php echo $bg; ?>;">
                    <table>
                        <tr>
                            ...
                            <?php if ($poll->user_metas->role == 'tutor') { ?>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="background: #F7B4B4;"><?php echo $poll->user_metas->role ?></td>
                                <td style="background: #F7B4B4;"><?php echo $poll->user_metas->sector ?></td>
                                <td style="background: #F7B4B4;"><?php echo $poll->user_metas->age ?></td>
                                <td style="background: #F7B4B4;"><?php echo $poll->user_metas->phone ?></td>
                                <td style="background: #F7B4B4;"><?php echo $poll->user_metas->calling_code . ' ' . $poll->user_metas->mobile ?></td>
                                <td style="background: #F7B4B4;"><?php echo $poll->user_metas->location ?></td>
                                <td style="background: #F7B4B4;"><?php echo $poll->user_metas->school ?></td>
                                <?php if ($poll->user_metas->role == 'tutor') { ?>
                                    <td style="background: #F7B4B4;"><?php echo $poll->user_metas->children ?></td>
                                <?php } ?>
                            </tr>
                        </tbody>
                    </table>
