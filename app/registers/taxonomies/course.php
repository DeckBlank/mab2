...
function taxonomy_mab_course() {
    $settings = [
        'name_taxonomy_plural'   => 'MAB categorias',
        'name_taxonomy_Singular' => 'MAB Categoria',
        'name_register_taxonomy' => 'tax-mab-course',
        'rewrite_slug'           => 'curso',
        'post_type'              => [ 'course' ],
        'text_domain'            => 'pandawp'
    ];
...
add_action( 'init', 'taxonomy_mab_course', 0 );
