...
function custom_post_type_event() {
    $settings = [
        'name_post_type_plural'   => 'Charlas',
        'name_post_type_Singular' => 'Charla',
        'name_register_post_type' => 'event',
        'rewrite_slug'            => 'charla',
        'supports_post_type'      => [ 'title', 'excerpt', 'editor', 'thumbnail' ],
        'taxonomy_post_type'      => [],
        'menu_icon_post_type'     => 'dashicons-calendar-alt',
