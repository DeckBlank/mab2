...
function custom_post_type_topic() {
  $settings = [
    'name_post_type_plural'   => 'Temas',
    'name_post_type_Singular' => 'Tema',
    'name_register_post_type' => 'topic',
    'rewrite_slug'            => 'tema',
    'supports_post_type'      => [ 'title', 'editor', 'thumbnail' ],
    'taxonomy_post_type'      => [],
    'menu_icon_post_type'     => 'dashicons-video-alt3',
    'text_domain'             => 'pandawp'
  ];
...
add_action( 'init', 'custom_post_type_topic', 0 );
