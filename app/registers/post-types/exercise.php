...
function custom_post_type_exercise() {
  $settings = [
    'name_post_type_plural'   => 'Ejercicios',
    'name_post_type_Singular' => 'Ejercicio',
    'name_register_post_type' => 'exercise',
    'rewrite_slug'            => 'ejercicio',
    'supports_post_type'      => [ 'title', 'editor', 'thumbnail' ],
    'taxonomy_post_type'      => [],
    'menu_icon_post_type'     => 'dashicons-media-document',
    'text_domain'             => 'pandoramarketing'
  ];
...
add_action( 'init', 'custom_post_type_exercise', 0 );
