...
/******/ 	deferredModules.push([10,"package.swiper","package.dom7","package.ssr-window","package.vue","package.vuex","package.vue-awesome-swiper","package.setimmediate","package.process","package.timers-browserify","package.opentok"]);
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ \"./node_modules/@babel/runtime/helpers/defineProperty.js\");\n/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue */ \"./node_modules/vue/dist/vue.esm.js\");\n/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vuex */ \"./node_modules/vuex/dist/vuex.esm.js\");\n/* harmony import */ var vue_awesome_swiper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! vue-awesome-swiper */ \"./node_modules/vue-awesome-swiper/dist/vue-awesome-swiper.js\");\n/* harmony import */ var vue_awesome_swiper__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(vue_awesome_swiper__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../app */ \"./src/js/app.js\");\n/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../store */ \"./src/js/store.js\");\n/* harmony import */ var _opentok_client__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @opentok/client */ \"./node_modules/@opentok/client/dist/js/opentok.js\");\n/* harmony import */ var _opentok_client__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_opentok_client__WEBPACK_IMPORTED_MODULE_6__);\n\n\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }\n\n\n\n\n\n\n\nvar session = new vue__WEBPACK_IMPORTED_MODULE_1__[\"default\"](_objectSpread({}, Object(_app__WEBPACK_IMPORTED_MODULE_4__[\"baseConfig\"])(_store__WEBPACK_IMPORTED_MODULE_5__[\"store\"]), {\n  data: function data() {\n    return {\n      //Chat\n      isActiveChat: false,\n      messages: [],\n      chatEditor: '',\n      //Session\n      session: null,\n      users: [],\n      isShowedUsersList: true,\n      credentials: {\n        apiKey: '',\n        sessionId: '',\n        token: ''\n      },\n      publisher: null,\n      publisher_screen: null,\n      subscribers: [],\n      mediaControls: {\n        video: true,\n        audio: true\n      },\n      //Swiper\n      swiperOptions: {\n        speed: 500,\n        preventClicks: false,\n        preventClicksPropagation: false,\n        slidesPerView: 6,\n        allowTouchMove: false,\n        navigation: {\n          prevEl: '.c-users__prev',\n          nextEl: '.c-users__next'\n        },\n        breakpoints: {\n          320: {\n            slidesPerView: 3,\n            spaceBetween: 20\n          },\n          480: {\n            slidesPerView: 4,\n            spaceBetween: 30\n          },\n          640: {\n            slidesPerView: 5,\n            spaceBetween: 40\n          },\n          1024: {\n            slidesPerView: 6,\n            spaceBetween: 40\n          }\n        }\n      }\n    };\n  },\n  components: {\n    Swiper: vue_awesome_swiper__WEBPACK_IMPORTED_MODULE_3__[\"Swiper\"],\n    SwiperSlide: vue_awesome_swiper__WEBPACK_IMPORTED_MODULE_3__[\"SwiperSlide\"]\n  },\n  computed: _objectSpread({}, Object(_app__WEBPACK_IMPORTED_MODULE_4__[\"baseState\"])(), {}, vuex__WEBPACK_IMPORTED_MODULE_2__[\"default\"].mapState(['activedSession']), {\n    swiper: function swiper() {\n      return this.$refs.slider_users.$swiper;\n    }\n  }),\n  directives: {\n    swiper: vue_awesome_swiper__WEBPACK_IMPORTED_MODULE_3__[\"directive\"]\n  },\n  created: function created() {\n    if (!this.activedSession) {\n      window.location = this.SITE_URL;\n    }\n  },\n  mounted: function mounted() {\n    this.users.push({\n      stream: {\n        id: 'publisher',\n        name: this.activedSession.publisher\n      }\n    });\n    this.openRoom();\n  },\n  methods: _objectSpread({}, Object(_app__WEBPACK_IMPORTED_MODULE_4__[\"baseActions\"])(), {\n    endSession: function endSession() {\n      window.localStorage.removeItem('mab_session');\n      window.location = \"\".concat(this.SITE_URL, \"/mab-click\");\n    },\n    openRoom: function openRoom() {\n      var _this = this;\n\n      var SERVER_BASE_URL = 'https://pkclass.cleivervalera.com';\n      fetch(SERVER_BASE_URL + '/session').then(function (res) {\n        return res.json();\n      }).then(function (res) {\n        _this.apiKey = res.apiKey;\n        _this.sessionId = res.sessionId;\n        _this.token = res.token;\n\n        _this.initSession();\n      }).catch(this.handleError);\n    },\n    initSession: function initSession() {\n      var _this2 = this;\n\n      this.session = _opentok_client__WEBPACK_IMPORTED_MODULE_6___default.a.initSession(this.apiKey, this.sessionId);\n      this.session.on('streamCreated', function (event) {\n        _this2.users.push({\n          stream: event.stream\n        });\n\n        window.setTimeout(function () {\n          _this2.session.subscribe(event.stream, \"user-\".concat(event.stream.id), {\n            insertMode: 'append',\n            width: '100%',\n            height: '100%'\n          }, _this2.handleError);\n\n          _this2.session.subscribe(event.stream, 'monitor', {\n            insertMode: 'replace',\n            width: '100%',\n            height: '100%'\n          }, _this2.handleError);\n        }, 100);\n      });\n      this.session.on('streamDestroyed', function (event) {\n        _this2.users = _this2.users.filter(function (el) {\n          return el.stream.id != event.stream.id;\n        });\n      });\n      this.session.on('signal:msg', function (event) {\n        var message = JSON.parse(event.data);\n\n        _this2.messages.push({\n          author: message.author,\n          content: message.content,\n          time: message.time\n        });\n\n        window.setTimeout(function () {\n          _this2.$refs[\"message-\".concat(_this2.messages.length - 1)][0].scrollIntoView();\n        }, 100);\n      });\n      this.session.connect(this.token, function (error) {\n        if (error) {\n          _this2.handleError(error);\n        } else {\n          _this2.shareVideo();\n        }\n      });\n    },\n    shareScreen: function shareScreen() {\n      var _this3 = this;\n\n      _opentok_client__WEBPACK_IMPORTED_MODULE_6___default.a.checkScreenSharingCapability(function (response) {\n        if (!response.supported || response.extensionRegistered === false) {\n          alert('Este navegador no soporte compartir pantalla');\n        } else if (response.extensionInstalled === false) {\n          alert('Usted necesita una extension extra');\n        } else {\n          _this3.session.unpublish(_this3.publisher);\n\n          _this3.users.push({\n            stream: {\n              id: 'publisher-screen',\n              name: \"\".concat(_this3.activedSession.publisher, \" - Pantalla\")\n            }\n          });\n\n          window.setTimeout(function () {\n            _this3.publisher_screen = _opentok_client__WEBPACK_IMPORTED_MODULE_6___default.a.initPublisher('user-publisher-screen', {\n              videoSource: 'screen',\n              name: \"\".concat(_this3.activedSession.publisher, \" - Pantalla\")\n            }, _this3.handleError);\n\n            _this3.publisher_screen.on('mediaStopped', function (event) {\n              _this3.users = _this3.users.filter(function (el) {\n                return el.stream.id != 'publisher-screen';\n              });\n\n              _this3.session.unpublish(_this3.publisher_screen);\n\n              window.setTimeout(_this3.shareVideo, 100);\n            });\n\n            _this3.session.publish(_this3.publisher_screen, _this3.handleError);\n          }, 100);\n        }\n      });\n    },\n    shareVideo: function shareVideo() {\n      this.publisher = _opentok_client__WEBPACK_IMPORTED_MODULE_6___default.a.initPublisher('user-publisher', {\n        insertMode: 'append',\n        width: '100%',\n        height: '100%',\n        name: this.activedSession.publisher\n      }, this.handleError);\n      this.session.publish(this.publisher, this.handleError);\n    },\n    updateMediaStatus: function updateMediaStatus(media) {\n      if (media == 'video') {\n        this.publisher.publishVideo(this.mediaControls.video = !this.mediaControls.video);\n      } else if (media == 'audio') {\n        this.publisher.publishAudio(this.mediaControls.audio = !this.mediaControls.audio);\n      }\n    },\n    setMonitor: function setMonitor(user_stream_id) {\n      if (user_stream_id != 'publisher' && user_stream_id != 'publisher-screen') {\n        this.session.subscribe(this.users.filter(function (el) {\n          return el.stream.id == user_stream_id;\n        })[0].stream, 'monitor', {\n          insertMode: 'replace',\n          width: '100%',\n          height: '100%'\n        }, this.handleError);\n      }\n    },\n    sendMessage: function sendMessage() {\n      var _this4 = this;\n\n      this.session.signal({\n        type: 'msg',\n        data: JSON.stringify({\n          author: this.activedSession.publisher,\n          content: this.chatEditor,\n          time: \"\".concat(new Date().getHours(), \":\").concat(new Date().getMinutes())\n        })\n      }, function (error) {\n        if (error) {\n          console.log('Error sending signal:', error.name, error.message);\n        } else {\n          _this4.chatEditor = '';\n        }\n      });\n    },\n    handleError: function handleError(error) {\n      if (error) {\n        alert(error.message);\n      }\n    }\n  })\n}));\n\n//# sourceURL=webpack:///./src/js/pages/page-session.js?");
