...
/******/ 	deferredModules.push([9,"package.babel","package.vue","package.vuex","package.setimmediate","package.process","package.timers-browserify","package.webpack"]);
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ \"./node_modules/@babel/runtime/helpers/defineProperty.js\");\n/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue */ \"./node_modules/vue/dist/vue.esm.js\");\n/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../app */ \"./src/js/app.js\");\n/* harmony import */ var _libs_shop_cart__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../libs/shop-cart */ \"./src/js/libs/shop-cart.js\");\n/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../store */ \"./src/js/store.js\");\n\n\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }\n\n\n\n\n\nvar course = new vue__WEBPACK_IMPORTED_MODULE_1__[\"default\"](_objectSpread(_objectSpread({}, Object(_app__WEBPACK_IMPORTED_MODULE_2__[\"baseConfig\"])(_store__WEBPACK_IMPORTED_MODULE_4__[\"store\"])), {}, {\n  data: function data() {\n    return {\n      metas: new URLSearchParams(window.location.search),\n      isActiveUnity: false,\n      isAvaibleCourse: true,\n      isActiveSignUp: false,\n      accessGranted: false,\n      area: '',\n      unities: []\n    };\n  },\n  computed: _objectSpread({}, Object(_app__WEBPACK_IMPORTED_MODULE_2__[\"baseState\"])()),\n  mounted: function mounted() {\n    this.area = this.$refs.course.getAttribute('data-area');\n    this.global();\n    this.isUserAuthOnCourse(this.$refs.course.getAttribute('data-id'));\n    this.saveCourseOnMetas();\n    this.verifyIsAvaibleCourse();\n    this.getUnities(this.$refs.course.getAttribute('data-id'));\n  },\n  methods: _objectSpread(_objectSpread({}, Object(_app__WEBPACK_IMPORTED_MODULE_2__[\"baseActions\"])()), {}, {\n    getUnities: function getUnities(course_id) {\n      var _this = this;\n\n      fetch(\"\".concat(this.API, \"/course/\").concat(course_id, \"/unities?user=\").concat(this.logedUser.user_email)).then(function (res) {\n        if (res.status >= 200 && res.status < 300) {\n          return res.json();\n        } else {\n          throw res;\n        }\n      }).then(function (unities) {\n        _this.unities = unities;\n\n        _this.hideLoading();\n      }).catch(function (err) {\n        throw err;\n      });\n    },\n    isUserAuthOnCourse: function isUserAuthOnCourse(course_id) {\n      var _this2 = this;\n\n      if (this.metas.get('sector') != 'privado' && this.metas.get('sector') != 'publico') {\n        window.location = \"\".concat(this.SITE_URL, \"/emotional\");\n      } else {\n        if (['creative', 'emotional'].includes(this.area)) {\n          this.accessGranted = true;\n        } else if (this.logedUser && this.logedUser.user_rol != 'foreign') {\n          if (this.metas.get('sector') == 'privado') {\n            fetch(\"\".concat(this.API, \"/course/\").concat(course_id, \"/registration/checkout?user=\").concat(this.logedUser.user_email), {\n              method: 'GET'\n            }).then(function (res) {\n              if (res.status >= 200 && res.status < 300) {\n                return res.json();\n              } else {\n                throw res;\n              }\n            }).then(function (registration) {\n              _this2.accessGranted = true;\n            }).catch(function (err) {\n              throw err;\n            });\n          } else if (this.metas.get('sector') == 'publico') {\n            this.accessGranted = true;\n          }\n        }\n      }\n    },\n    saveCourseOnMetas: function saveCourseOnMetas() {\n      window.localStorage.setItem('mab_metas', JSON.stringify({\n        course: this.$refs.course.getAttribute('data-title')\n      }));\n    },\n    addCourse: function addCourse(course_id, course_title, course_link) {\n      Object(_libs_shop_cart__WEBPACK_IMPORTED_MODULE_3__[\"addCourseToShopCart\"])(course_id, course_title, course_link, this.SITE_URL, this.metas);\n    },\n    verifyIsAvaibleCourse: function verifyIsAvaibleCourse() {\n      var _this3 = this;\n\n      var shop_cart = window.localStorage.getItem('mab_shop_cart');\n      shop_cart = JSON.parse(shop_cart);\n\n      if (shop_cart) {\n        var courses = shop_cart.filter(function (course) {\n          return course.id == _this3.$refs.course.getAttribute('data-id');\n        });\n        this.isAvaibleCourse = courses.length > 0 ? false : true;\n      }\n    },\n    playVideo: function playVideo(video, unity, topic) {\n      event.preventDefault();\n\n      if (this.metas.get('sector') == 'privado') {\n        /*\n          TODO: if(this.accessGranted || (unity == 1 && topic == 1)){\n        */\n        if (this.accessGranted) {\n          window.location = video;\n        } else {\n          if (this.logedUser && this.logedUser.user_rol != 'foreign') {\n            if (unity == 1 && topic == 1) {\n              window.location = video;\n            } else {\n              Object(_libs_shop_cart__WEBPACK_IMPORTED_MODULE_3__[\"addCourseToShopCart\"])(this.$refs.course.getAttribute('data-id'), this.$refs.course.getAttribute('data-title'), this.$refs.course.getAttribute('data-link'), this.SITE_URL, this.metas);\n            }\n          } else {\n            this.isActiveSignUp = true;\n          }\n        }\n      } else if (this.metas.get('sector') == 'publico') {\n        if (this.accessGranted) {\n          window.location = video;\n        } else {\n          this.isActiveSignUp = true;\n        }\n      }\n    },\n    downloadMaterial: function downloadMaterial(unity, topic, topic_id, url, media) {\n      event.preventDefault();\n\n      if (this.metas.get('sector') == 'privado') {\n        /*\n          TODO: if(this.accessGranted || (unity == 1 && topic == 1)){\n        */\n        if (this.accessGranted) {\n          this.saveMaterialLog(topic_id, url, media);\n        } else {\n          if (this.logedUser && this.logedUser.user_rol != 'foreign') {\n            if (unity == 1 && topic == 1) {\n              window.location = video;\n            } else {\n              Object(_libs_shop_cart__WEBPACK_IMPORTED_MODULE_3__[\"addCourseToShopCart\"])(this.$refs.course.getAttribute('data-id'), this.$refs.course.getAttribute('data-title'), this.$refs.course.getAttribute('data-link'), this.SITE_URL, this.metas);\n            }\n          } else {\n            this.isActiveSignUp = true;\n          }\n        }\n      } else if (this.metas.get('sector') == 'publico') {\n        if (this.accessGranted) {\n          this.saveMaterialLog(topic_id, url, media);\n        } else {\n          this.isActiveSignUp = true;\n        }\n      }\n    },\n    saveMaterialLog: function saveMaterialLog(topic_id, url, media) {\n      var course_id = this.$refs.course.getAttribute('data-id'),\n          user = this.logedUser ? this.logedUser.user_email : 'anonimo';\n      fetch(\"\".concat(this.API, \"/topic/\").concat(topic_id, \"/material/log?user=\").concat(user, \"&course_id=\").concat(course_id, \"&media=\").concat(media), {\n        method: 'PUT'\n      }).then(function (res) {\n        if (res.status >= 200 && res.status < 300) {\n          return res.json();\n        } else {\n          throw res;\n        }\n      }).then(function (response) {\n        window.open(url, '_blank');\n      }).catch(function (err) {\n        window.open(url, '_blank');\n        throw err;\n      });\n    }\n  })\n}));\n\n//# sourceURL=webpack:///./src/js/pages/page-course.js?");
...
/***/ 9:
/*!*******************************************!*\
  !*** multi ./src/js/pages/page-course.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("module.exports = __webpack_require__(/*! C:\\laragon\\www\\mab\\wp-content\\themes\\mab\\src\\js\\pages\\page-course.js */\"./src/js/pages/page-course.js\");\n\n\n//# sourceURL=webpack:///multi_./src/js/pages/page-course.js?");
